...
\date{Anno accademico 2025/2026 -- versione finale 11 settembre 2026}
...
\subsection{DCAT}
DCAT definisce Dataset e Distribution per l'interoperabilità dei cataloghi \cite{dcat3}; DCAT-AP ne specifica il profilo europeo \cite{dcatap}. Il progetto include \texttt{metadata/dcat.ttl}, una descrizione RDF/DCAT locale del dataset e delle relative distribuzioni. Il repository non dichiara una conformità operativa completa a DCAT-AP\_IT: le URL di accesso e download sono URI locali \texttt{file:} e il namespace di progetto utilizza il dominio di sviluppo \texttt{.invalid}. Una pubblicazione reale richiederebbe URI HTTP(S) pubbliche e una validazione rispetto al profilo applicabile.
